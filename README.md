...
- Currently exploring AI-based projects, Generative AI, and Prompt Engineering techniques
...
`Machine Learning` • `Natural Language Processing (NLP)` • `Generative AI` • `Prompt Engineering` • `LLM Applications`

---

## Core Competencies

`Data Structures & Algorithms` • `Object-Oriented Programming` • `REST APIs` • `Software Development Life Cycle` • `Agile Methodologies` • `Scrum` • `Design Patterns` • `Unit Testing` • `Debugging` • `Prompt Engineering` • `Problem Solving`
...
- Prompt Engineering and LLM-powered Applications
