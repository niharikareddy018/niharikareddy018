...
**Java | Spring Boot | Microservices | LLM | PostgreSQL | PGVector | RabbitMQ**

- Developed an AI-powered document assistant using Retrieval-Augmented Generation.
- Designed document processing pipeline with parsing, semantic chunking, and embedding generation.
- Implemented vector similarity search using PostgreSQL and PGVector.
- Built asynchronous workflows using RabbitMQ.
...
- Implemented Ant Colony Optimization algorithm for route optimization.
- Generated distance matrices using real-world geographical data.
- Developed interactive visualization for optimized routes.

---

### Suicide Note Detection using Machine Learning

**Python | NLP | Scikit-learn**

- Developed NLP-based text classification system.
- Applied TF-IDF feature extraction and machine learning algorithms.
- Evaluated models using accuracy, precision, recall, and F1-score.

---

### Number Plate Recognition & Vehicle Counting

**Java | OpenCV | Computer Vision**

- Built computer vision-based vehicle monitoring system.
- Implemented image processing techniques for vehicle detection.
- Used OCR techniques for automated license plate recognition.
